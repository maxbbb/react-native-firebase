...
export default class StorageReference extends ReferenceBase {
  ...
  putFile(filePath: string, metadata: Object = {}): Promise<Object> {
    return new StorageTask(UPLOAD_TASK, this._module._native.putFile(this.path, filePath, metadata), this);
    }   
}
